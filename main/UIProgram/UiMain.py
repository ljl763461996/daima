...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QtCore.QRect(10, 100, 900, 800))
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.frame_2 = QtWidgets.QFrame(self.frame)
        self.frame_2.setGeometry(QtCore.QRect(10, 0, 880, 550))
        self.frame_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_2.setObjectName("frame_2")
        self.label_show = QtWidgets.QLabel(self.frame_2)
        self.label_show.setGeometry(QtCore.QRect(0, 0, 880, 550))
        self.label_show.setMinimumSize(QtCore.QSize(880, 550))
        self.label_show.setMaximumSize(QtCore.QSize(880, 550))
        ...
        self.frame_3.setGeometry(QtCore.QRect(10, 550, 880, 240))
        self.frame_3.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_3.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_3.setObjectName("frame_3")
        self.groupBox_3 = QtWidgets.QGroupBox(self.frame_3)
        self.groupBox_3.setGeometry(QtCore.QRect(0, 10, 880, 221))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        ...
        self.tableWidget.setGeometry(QtCore.QRect(10, 30, 860, 200))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        ...
        self.frame_4.setGeometry(QtCore.QRect(920, 100, 460, 800))
        self.frame_4.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_4.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_4.setObjectName("frame_4")
        self.groupBox = QtWidgets.QGroupBox(self.frame_4)
        self.groupBox.setGeometry(QtCore.QRect(0, 0, 460, 120))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(16)
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 30, 210, 31))
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(230, 30, 210, 31))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(0, 120, 460, 400))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(16)
        ...
        self.frame_6.setGeometry(QtCore.QRect(0, 190, 460, 200))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 60, 180, 37))
        ...
        self.label_xmin.setMinimumWidth(100)  # 增加最小宽度
        self.horizontalLayout.addWidget(self.label_xmin)
        self.layoutWidget1 = QtWidgets.QWidget(self.frame_6)
        self.layoutWidget1.setGeometry(QtCore.QRect(210, 60, 180, 37))
        ...
        self.label_ymin.setMinimumWidth(100)  # 增加最小宽度
        self.horizontalLayout_2.addWidget(self.label_ymin)
        self.layoutWidget2 = QtWidgets.QWidget(self.frame_6)
        self.layoutWidget2.setGeometry(QtCore.QRect(20, 120, 180, 37))
        ...
        self.label_xmax.setMinimumWidth(100)  # 增加最小宽度
        self.horizontalLayout_3.addWidget(self.label_xmax)
        self.layoutWidget3 = QtWidgets.QWidget(self.frame_6)
        self.layoutWidget3.setGeometry(QtCore.QRect(210, 120, 180, 37))
        ...
        self.layoutWidget5.setGeometry(QtCore.QRect(10, 90, 310, 38))
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(10, 40, 190, 37))
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(210, 140, 210, 41))
        ...
        self.layoutWidget_3.setGeometry(QtCore.QRect(10, 140, 190, 41))
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(0, 520, 460, 260))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(16)
        ...
        self.widget.setGeometry(QtCore.QRect(17, 30, 426, 220))
        self.widget.setObjectName("widget")
        self.formLayout = QtWidgets.QFormLayout(self.widget)
        self.formLayout.setLabelAlignment(QtCore.Qt.AlignCenter)
        self.formLayout.setFormAlignment(QtCore.Qt.AlignCenter)
        self.formLayout.setContentsMargins(0, 0, 90, 0)
        ...
        self.FilesBtn.setIconSize(QtCore.QSize(24, 24))
        ...
        self.VideoBtn.setIconSize(QtCore.QSize(24, 24))
        ...
        self.CapBtn.setIconSize(QtCore.QSize(24, 24))
        ...
        self.label_2.setGeometry(QtCore.QRect(20, 60, 350, 21))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(14)
        ...
        self.label_12.setGeometry(QtCore.QRect(1100, 60, 150, 21))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(14)
        font.setUnderline(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "基于深度学习的西红柿成熟度检测系统"))
        ...
        self.label_3.setText(_translate("MainWindow", "兰州城市道路车辆计数系统"))
